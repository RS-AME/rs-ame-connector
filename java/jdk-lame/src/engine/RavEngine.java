...
public class RavEngine {
	...
	public native long LameScanFileWithCallback(long lame, String fname, JdkInterface cb);
	public native ScanResult LameScanMem(long lame, byte [] data);
	public native long LameScanMemWithCallback(long lame, byte [] data, JdkInterface cb);
	...
	// callback
	//public native long LameSetCallback(JdkInterface cb);
	//public native long LameResetCallback(JdkInterface cb);
